...
pacman -S networkmanager --needed network-manager-applet bluez bluez-utils wireless_tools wpa_supplicant dialog reflector mtools vim vifm neovim snapper os-prober grub efibootmgr zsh
